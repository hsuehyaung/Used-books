    ...
    <div>
        ...
        <div class="body">
            <el-table :data="tableData" style="width: 100%" class="table" border>
                ...
                <el-table-column prop="orderway" label="订购方式" width="100" align="center">
                </el-table-column>
                <el-table-column prop="cons_phone" label="收件人电话" width="200" align="center">
                </el-table-column>
                <el-table-column prop="cons_name" label="收件人姓名" width="100" align="center">
                </el-table-column>
                <el-table-column prop="cons_addre" label="收件地址" width="200" align="center">
                </el-table-column>
